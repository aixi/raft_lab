...
func (cfg *config) start1(i int) {
	...
	ends := make([]*rpc_mock.ClientEnd, cfg.n)
	for j := 0; j < cfg.n; j++ {
...
func (cfg *config) setLongReordering(flag bool) {
	cfg.net.LongReordering(flag)
}
